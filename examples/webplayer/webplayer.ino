 ...
 * \file WebPlayer.ino
 *
 * \brief Example sketch of using the VS1053 Arduino driver to create a webserver
 ...
 * vs1053 library demonstrating the VS1053 commanded through a web browser.
 *
 * \warning
 * Need to set the following in the vs1053Config.h, in order to work.
