...
Extensive support can be found at [ GitHub project page ](https://mpflaga.github.io/Arduino_Library-vs1053_for_SdFat/) along with trouble shooting of common problems. As the code has been written with plenty of insightful comments, describing key components, features and reasoning’s in Doxygen markdown style as to directly auto generate html supporting documentation. Which can be found at [ GitHub project page ](https://mpflaga.github.io/Arduino_Library-vs1053_for_SdFat/). Please read through this document and referring linked resources. As it contains additional resources.
