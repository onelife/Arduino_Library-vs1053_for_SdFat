 ...
 */
#if defined(PROFILE_LOADER)
/**
 * \brief A macro of the enumerated value used to select .img loader ("VSLoadImage")
 */
#define IMG_LOADER          0

/**
 * \brief A macro of the enumerated value used to select .053 loader ("VSLoadUserCode")
 */
#define PLG_LOADER          1
