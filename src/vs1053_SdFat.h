...
\brief Header file for the vs1053 library
...
/** \brief State of the vs1053 device
 *
 * Value of vs1053::playing_state detailing the current state of the VSdsp.
 ...
 *
 * For use with vs1053::flush_cancel(flush_m) as to how to flush the
 * VSdsp's buffer.
 *
 ...
 * of vs1053 and accessed by static functions.
 */
extern SdFat sd;
 ...
 *
 * \note This is only available with patch loaded. Typically done with vs1053::vs_init()
 */
 ...
 * microphone input.
 *
 * Used by vs1053::ADMixerLoad to determine if the SM_LINE1 of SCI_MODE being set as to
